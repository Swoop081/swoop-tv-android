export const PROFILE_AVATARS=[
  ...
  {id:'cheetah',label:'Cheetah',image:'./assets/avatar-cheetah.svg'},
  {id:'seal',label:'Seal',image:'./assets/avatar-seal.svg'},
  {id:'triceratops',label:'Triceratops',image:'./assets/avatar-triceratops.svg'},
  {id:'capybara',label:'Capybara',image:'./assets/avatar-capybara.svg'},
  {id:'panda',label:'Panda',image:'./assets/avatar-panda.svg'},
  {id:'dinosaur',label:'Dinosaur',image:'./assets/avatar-dinosaur.svg'},
  {id:'red-panda',label:'Red Panda',image:'./assets/avatar-red-panda.svg'},
  {id:'kangaroo',label:'Kangaroo',image:'./assets/avatar-kangaroo.svg'},
  {id:'dog',label:'Dog',image:'./assets/avatar-dog.svg'},
  {id:'cat',label:'Cat',image:'./assets/avatar-cat.svg'}
];
