...
function bind(){
  ...
  document.querySelectorAll('[data-show-whats-new]').forEach(el=>el.onclick=()=>{androidLatestManifest={version:ANDROID_CURRENT_VERSION,versionCode:837,changes:[...ANDROID_CURRENT_CHANGELOG]};modal='whatsNew';render()});
